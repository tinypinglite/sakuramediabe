...
from src.model import Image, ImageSearchSession, Media, MediaLibrary, MediaThumbnail, Movie
...
def image_search_tables(test_db):
    models = [Image, Movie, MediaLibrary, Media, MediaThumbnail, ImageSearchSession]
